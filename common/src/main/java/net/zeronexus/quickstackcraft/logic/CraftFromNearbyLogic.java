...
public final class CraftFromNearbyLogic {
    ...
    public static CraftResult execute(Player player, List<Optional<Ingredient>> ingredients,
    ...
    private static Plan createPlan(List<Optional<Ingredient>> ingredients, List<Slot> craftSlots,
        ...
        for (int amount = firstAmount; amount >= 1; amount--) {
            ...
            for (int gridSlot : requiredGridSlots) {
                Ingredient ingredient = ingredients.get(gridSlot).orElseThrow();
