...
final class TutorialSeekBar extends AbstractWidget {
    ...
    TutorialSeekBar(int x, int y, int width, TutorialPlaybackController playback, int accent) {
        super(x, y, width, 12, Component.translatable("quickstackcraft.tutorial.timeline"));
        this.playback = playback;
        this.accent = accent;
        setTooltip(Tooltip.create(Component.translatable("quickstackcraft.tutorial.timeline.help")));
    }
    ...
    @Override protected void updateWidgetNarration(NarrationElementOutput output) {
        ...
        output.add(NarratedElementType.POSITION, Component.translatable("quickstackcraft.tutorial.time",
                (int) playback.elapsedSeconds(), (int) playback.duration()));
        output.add(NarratedElementType.USAGE, Component.translatable("quickstackcraft.tutorial.timeline.help"));
    }
}
